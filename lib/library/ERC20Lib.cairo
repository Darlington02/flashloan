...
func ERC20_transferFrom{
    ...
    with_attr error_message("ERC20: transfer amount exceeded allowance"){
...
func ERC20_increaseAllowance{
    ...
    with_attr error_message("ERC20: added_value is not a valid Uint256"){
...
func ERC20_mint{
    ...
    with_attr error_message("ERC20: cannot mint to zero address"){
...
func ERC20_burn{
    ...
    with_attr error_message("ERC20: cannot burn from zero address"){
...
func _transfer{
    ...
    with_attr error_message("ERC20: cannot transfer from a zero address"){
        assert_not_zero(sender);
    }

    with_attr error_message("ERC20: cannot transfer to a zero address"){
        assert_not_zero(recipient);
    }
