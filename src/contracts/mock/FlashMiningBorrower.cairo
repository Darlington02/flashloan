...
@external
func set_mining_contract{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
...
@external
func on_flash_loan{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr
}(
    initiator: felt,
    token: felt,
    amount: Uint256,
...
@external
func flash_borrow{syscall_ptr: felt*,  pedersen_ptr: HashBuiltin*, range_check_ptr
}(
    token: felt,
    amount: Uint256,
    data: felt
